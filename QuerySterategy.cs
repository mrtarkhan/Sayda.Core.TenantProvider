...
{
	public class QuerySterategy : ITenantIdentificationSterategy
	{
		private readonly string _tenantKey;
		private readonly int _tenantMaxKeySize;

		public QuerySterategy (Action<TenantOptions> setupAction)
		{
		...
		public string IdentifyTenant (object context)
		{
			...
			(context as HttpContext).Request.Query.TryGetValue(_tenantKey, out StringValues host);
